          ...
          <div className="footer-col">
            ...
            <div className="footer-contact-info">
              ...
              <div className="footer-social-links">
                <a href="https://wa.me/77477371429" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="WhatsApp">
                ...
                <a href="https://www.instagram.com/vager_autoparts_shymkent/" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Instagram">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://www.youtube.com/@YerzhanKuanyshov" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="YouTube">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
